...
'''base_model = applications.resnet50.ResNet50( include_top=False, weights='imagenet', input_tensor=None, input_shape=None,
    pooling='avg', classes=1000)
x = base_model.output
x = Dense(128,activation='relu')(x)
x = Dropout(0.2)(x)'''

base_model = applications.InceptionResNetV2( include_top=False, weights='imagenet', input_tensor=None, input_shape=None,
    pooling='avg', classes=1000)
x = base_model.output
x = Dense(128,activation='relu')(x)
x = Dropout(0.2)(x)
...
checkpointer = ModelCheckpoint(filepath='best_model_8class_InceptionResNetV2.hdf5', verbose=1, save_best_only=True)
...
model.save('model_trained_8class_InceptionResNetV2.hdf5')
...
plot_accuracy(history,'DANCE_FORM_8-InceptionResNetV2')
plot_loss(history,'DANCE_FORM_8-InceptionResNetV2')
